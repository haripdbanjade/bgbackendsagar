...
export default function PaymentLicenseCMS() {
  ...
  // When user selects a file from laptop
  const handleFileChange = (e) => {
    ...
    setNewMethod({
      ...newMethod,
      file,
      src: previewURL, // this is a blob URL for preview
    });
  };
      ...
      <div className="max-w-7xl mx-auto bg-[#111827] rounded-xl border border-gray-700 p-6 md:p-10 grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <div className="flex items-center gap-6 flex-wrap mb-6">
            {paymentMethods.map(method => (
              <div key={method.id} className="relative inline-block">
                <img src={method.src} alt={method.alt} width={method.width} height={method.height} />
                <button
          ...
          <div className="space-y-2 text-slate-300">
            ...
            />
            {newMethod.src && (
              <img src={newMethod.src} alt="preview" className="my-2 rounded border border-gray-600" style={{ maxWidth: '150px', maxHeight: '100px' }} />
            )}
            <input
            ...
            <button
              ...
              className="mt-2 bg-green-600 px-4 py-1 rounded text-white"
            >
              Add Payment Method
            </button>
          </div>
