...
const Dashboard = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-purple-100 via-pink-100 to-blue-100 px-4">
      <div className="bg-gradient-to-r from-blue-500 via-purple-600 to-pink-500 shadow-xl rounded-3xl p-6 sm:p-10 md:p-12 max-w-md sm:max-w-xl w-full text-center transition-transform transform hover:scale-[1.02]">
        ...
        {/* User Details */}
        {user && (
          <div className="bg-white/20 p-3 sm:p-4 rounded-lg text-white text-left mb-4">
        ...
        <button
          ...
          className="mt-5 sm:mt-6 bg-red-500 text-white py-2 sm:py-2.5 px-4 rounded-lg hover:bg-red-600 transition text-sm sm:text-base w-full"
        >
          Logout
        </button>

        {/* Footer Text */}
        <div className="text-white/80 italic mt-5 sm:mt-6 text-xs sm:text-sm">
